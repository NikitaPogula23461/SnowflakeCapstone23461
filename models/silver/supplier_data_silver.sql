...
CASE
    WHEN LENGTH(phone_number_clean) = 11 AND LEFT(phone_number_clean,1) = '1'
    THEN SUBSTRING(phone_number_clean,2)

    WHEN LENGTH(phone_number_clean) = 10 AND LEFT(phone_number_clean,1) = '1'
    THEN NULL
 
    WHEN LENGTH(phone_number_clean) = 10
    THEN phone_number_clean
